...
class CreateListenersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create(Config::get('amethyst.listener.managers.listener.table'), function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
    ...
    {
        Schema::dropIfExists(Config::get('amethyst.listener.managers.listener.table'));
    }
}
